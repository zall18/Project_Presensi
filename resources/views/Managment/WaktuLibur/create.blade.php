...
<div class="container mt-4">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        <div>
            <h3 class="fw-semibold mb-1">Tambah Waktu Libur</h3>
            <p class="text-muted mb-0">Tambah hari libur baru ke sistem</p>
        </div>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <form action="{{ route('waktuLibur.store') }}" method="POST">
                @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end pe-4">
                                            <div class="d-flex gap-2 justify-content-end">
                                                <input type="checkbox" name="groups[]" id="group" value="{{ $group->id }}" class="form-check-input">
                                            </div>
                                        </td>
                                    </tr>
                                    @empty
                ...
                <div class="mt-4 pt-2 border-top">
                    <button type="submit" class="btn btn-primary px-4">
                        <i class="ti ti-calendar-plus me-1"></i> Simpan
                    </button>
